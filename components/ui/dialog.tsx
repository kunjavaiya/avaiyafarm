...
function DialogViewport({
  ...
  return (
    <DialogPrimitive.Viewport
      ...
      className={cn(
        "fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 overflow-y-auto",
        className
      )}
      {...props}
    />
